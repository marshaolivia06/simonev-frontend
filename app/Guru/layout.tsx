    ...
    children: [
      {
        ...
        href: "/guru/penilaian-perkembangan",
      },
      {
        label: "Laporan Perkembangan",
        href: "/guru/laporan-perkembangan",
      },
    ],
  },
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          ...
          {/* Dropdown Guru (tanpa icon) */}
          <div className="relative">
            <button
              onClick={() => setOpen(!open)}
              className="bg-[#1976D2] text-white px-4 py-1.5 rounded-lg text-sm font-medium hover:bg-[#1565C0] transition"
            >
              Guru
            </button>
