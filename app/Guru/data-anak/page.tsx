...
const dataAwal: Anak[] = [
  { id: 1, namaAnak: "Aisyah Azizah", orangTua: "Sari Sri Hastuti", email: "sari@email.com", alamat: "Jl. Melati No. 1", kelas: "A" },
  { id: 2, namaAnak: "Bima Sakti", orangTua: "Andi Saputra", email: "andi@email.com", alamat: "Jl. Mawar No. 5", kelas: "B" },
  { id: 3, namaAnak: "Citra Lestari", orangTua: "Lina Wijaya", email: "lina@email.com", alamat: "Jl. Kenanga No. 3", kelas: "A" },
  { id: 4, namaAnak: "Dafa Ramadhan", orangTua: "Budi Santoso", email: "budi@email.com", alamat: "Jl. Anggrek No. 7", kelas: "C" },
  { id: 5, namaAnak: "Elsa Nabila", orangTua: "Dewi Rahayu", email: "dewi@email.com", alamat: "Jl. Dahlia No. 2", kelas: "B" },
  { id: 6, namaAnak: "Farhan Maulana", orangTua: "Hendra Kusuma", email: "hendra@email.com", alamat: "Jl. Flamboyan No. 9", kelas: "A" },
  { id: 7, namaAnak: "Ghina Aulia", orangTua: "Rina Marlina", email: "rina@email.com", alamat: "Jl. Tulip No. 4", kelas: "C" },
  { id: 8, namaAnak: "Hafiz Pratama", orangTua: "Yusuf Hakim", email: "yusuf@email.com", alamat: "Jl. Bougenville No. 6", kelas: "B" },
  { id: 9, namaAnak: "Indira Putri", orangTua: "Nita Sari", email: "nita@email.com", alamat: "Jl. Cempaka No. 8", kelas: "A" },
  { id: 10, namaAnak: "Jaka Tarub", orangTua: "Agus Priyono", email: "agus@email.com", alamat: "Jl. Seroja No. 10", kelas: "C" },
];
