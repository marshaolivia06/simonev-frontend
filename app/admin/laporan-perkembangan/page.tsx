...
const anakPerKelas: Record<string, string[]> = {
  ...
  "TK A3": ["Elina Zahra","Mira Safitri","Hendra Gunawan","Putri Andriani","Rafly Santoso","Syifa Aulia"],
  "TK B1": ["Citra Anindya","Naufal Rizky","Ahmad Fauzi","Bella Wulandari","Dina Marlina","Evan Saputra"],
  "TK B2": ["Daffa Ramadhan","Olivia Darmawan","Fanny Kusuma","Gilang Pratama","Hana Rahayu","Ivan Setiawan"],
  "TK B3": ["Fahri Maulana","Putra Aditya","Kezia Santoso","Lina Permata","Mutiara Indah","Nabil Ardiansyah"],
  "Playgroup A": ["Gita Larasati","Rafi Ananda","Sinta Dewi","Wahyu Nugroho"],
  "Playgroup B": ["Hafiz Akbar","Salsabila Nur","Tiara Wulandari","Umar Faruq"],
};
